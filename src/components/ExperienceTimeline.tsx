...
const ROLES: Role[] = [
  {
    ...
    bullets: [
      ...
      'Tune VPD, temperature, and humidity parameters using hands-on cultivation knowledge; deepening understanding of how environment directly affects plant expression at each life stage.',
      'Guide newer gardeners on best cultivation practices; applying and expanding cultivation skills at larger facility scale.',
      'Observed and managed genetic mutations and hermaphrodite events; applied quarantine protocols and strategic room sectioning to contain and resolve issues.',
      'Studying plant training at different stages and sizes; refining techniques and understanding their effects across the lifecycle.',
    ...
    tags: ['Damatex', 'HVAC Controls', 'Irrigation Logic', 'VPD Tuning', 'Cultivation Leadership', 'IPM', 'Internal Tools'],
  },
  {
    ...
    bullets: [
      ...
      'Applied full cultivation cycle practices: planting, transplanting, defoliation, training, and post-production sanitation and destruction — all to Health Canada standards.',
      'Developed IPM knowledge: applying sprays (Vegol and others), preparing solutions, and performing systematic pest and hermaphrodite detection.',
      'Participated in the medical fulfillment department — inventory organization, space optimization, and complex logistics; contributed to record order days.',
      'Designed promotional materials and internal tools used across the facility.',
